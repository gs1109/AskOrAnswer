...
public class ConfigDataManager : MonoBehaviour 
{
	...
	void Start () 
	{
		...
		_fileManager.readConfigDataFromResources ();
		Debug.LogError ("Questions List : " + ConfigData.Instance.question_categories.Count);
		Debug.LogError ("Questions List Category : " + ConfigData.Instance.question_categories[0].category);
	}
